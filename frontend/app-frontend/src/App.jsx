    ...
    <> 
      <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Signup Shopify App</h2>
        </div>
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form className="space-y-6" action="#" method="POST">
            ...
            <div>
              <label htmlFor="emashopil" className="block text-sm font-medium leading-6 text-gray-900">Shop address</label>
              <div className="mt-2">
                <input 
                onChange={(e)=>{ 
                  setFormdata((previousdata)=>{
                    return {...previousdata,shop:e.target.value}
                  })
                }}
                id="shop" name="shop" type="text" required className="block w-full rounded-md border-0 py-1.5 px-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
              </div>
            </div>
